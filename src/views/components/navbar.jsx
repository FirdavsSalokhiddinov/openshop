                ...
                <Link to={`/productdetail/${product.id}`} onClick={() => setSearchBarVisible(false)}>
                                    ...
                                    {manufacturers
                                        ...
                                        .map((manufacturer) => (
                                            <NavDropdown.Item key={manufacturer.id}>
                                                <Link to={`/productcategory/${category.category}/${manufacturer.id}/`}>
                                                    {manufacturer.name}
                                                </Link>
                                            </NavDropdown.Item>
                                        ))}
                    ...
                    <Nav className="d-flex align-items-center ms-auto">
                        ...
                        <NavDropdown title={<FaUser />} id="user-dropdown" align="end" menuVariant="dark" className="user-dropdown">
                            <NavDropdown.Item>{isLoggedIn ? `Hi, ${username}` : <Link to="/login">Log in</Link>}</NavDropdown.Item>
                            <NavDropdown.Item>
                                {isLoggedIn ? <span onClick={handleLogout}>Logout</span> : <Link to="/register">Register</Link>}
                            </NavDropdown.Item>
                        </NavDropdown>
                    </Nav>
                </Navbar.Collapse>
